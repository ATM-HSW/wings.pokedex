...
a persistence unit "pokedexPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pokedex\pom.xml":
...
artifacts ("pokedex-ejb.jar" and "pokedex-web.war") are already built. You can build
